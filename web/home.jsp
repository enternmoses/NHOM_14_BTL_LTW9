...
<html>
    ...
    <body>
        <header>
            <div class="logo">
                <a href="http://localhost:8080/14_BTL_LTW9/home.jsp"><img src ="images/logo.png" style="max-width: 190px; display: block; margin-left: auto; margin-right: auto;"></a>
            </div>
            <ul class="menu">
                <li><a href="http://localhost:8080/14_BTL_LTW9/home.jsp" style="border: none;
    ...
    line-height: 40px;" value="Phụ kiện đồng hồ">
                        <input type="hidden" name="choice" value="acessory">
                    </form>
                </li>
                <li>
                    <form action="productServlet" method="POST"> 
